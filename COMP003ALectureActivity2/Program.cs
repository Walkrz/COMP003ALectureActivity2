 ...
 */
namespace COMP003ALectureActivity2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Concatenation using string interpolation : {aLetter} {message} "); // use string interpolation with a dollar-sign ($) before the
            // opening double-quote and enclosing variables with curly braces ({variableName})
            ...
            int arithmetic2 = 3 + 1; // declaring arithmetic2 and assigning a value to
            ...
            incrementDecrementOperators++; // The equivalent of
            // incrementDecrementOperators += 1; or incrementDecrementOperators =
            // incrementDecrementOperators + 1;
            incrementDecrementOperators--; // The equivalent of
            // incrementDecrementOperators -= 1; or incrementDecrementOperators =
            // incrementDecrementOperators - 1;
            ...
            Console.BackgroundColor = ConsoleColor.Yellow; // changes the console
            // background to yellow
            Console.ForegroundColor = ConsoleColor.Black; // changes the console text to
            // black
